...
//
//     final bookingDetailSupplier = bookingDetailSupplierFromJson(jsonString);

import 'dart:convert';

BookingDetailSupplier bookingDetailSupplierFromJson(String str) => BookingDetailSupplier.fromJson(json.decode(str));

String bookingDetailSupplierToJson(BookingDetailSupplier data) => json.encode(data.toJson());

class BookingDetailSupplier {
    Couple? couple;
    ...
    BookingDetailSupplier copyWith({
        Couple? couple,
        String? bookingDetailId,
        ServiceSupplierResponse? serviceSupplierResponse,
        double? price,
    ...
    factory BookingDetailSupplier.fromJson(Map<String, dynamic> json) => BookingDetailSupplier(
