...
class Booking {
    ...
    factory Booking.fromJson(Map<String, dynamic> json) => Booking(
        ...
        listBookingDetail: json["listBookingDetail"] == null ? [] : List<ListBookingDetail>.from(json["listBookingDetail"]!.map((x) => ListBookingDetail.fromJson(x))),
        note: json["note"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "listBookingDetail": listBookingDetail == null ? [] : List<dynamic>.from(listBookingDetail!.map((x) => x.toJson())),
        "note": note,
...
class ListBookingDetail {
    ...
    ListBookingDetail copyWith({
        ...
        ListBookingDetail(
            ...
            status: status ?? this.status,
            promotionServiceSupplier: promotionServiceSupplier ?? this.promotionServiceSupplier,
        );

    factory ListBookingDetail.fromJson(Map<String, dynamic> json) => ListBookingDetail(
        serviceSupplier: json["serviceSupplier"] == null ? null : ServiceSupplier.fromJson(json["serviceSupplier"]),
        id: json["id"],
...
class ServiceSupplier {
    ...
    factory ServiceSupplier.fromJson(Map<String, dynamic> json) => ServiceSupplier(
        id: json["id"],
        name: json["name"],
        ...
        price: json["price"]?.toDouble(),
        status: json["status"],
        supplierResponse: json["supplierResponse"] == null ? null : SupplierResponse.fromJson(json["supplierResponse"]),
